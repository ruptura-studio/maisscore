...
export default function OnboardingPage({
  ...
  const [pageState, setPageState] = useState<
    "loading" | "form" | "completed" | "invalid"
  >("loading");
  ...
  if (pageState === "completed") {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 bg-neutral-100 px-4">
        ...
        <p className="text-sm text-foreground-alt text-center max-w-sm">
          Suas informações foram registradas com sucesso. Nossa equipe vai
          iniciar seu processo em breve e você receberá atualizações pelo
          WhatsApp.
        </p>
        <button
          type="button"
  ...
  async function handleBackToProcess() {
    await savePartial()
    window.location.href = '/meuprocesso'
  }
    ...
    <div className="min-h-screen bg-neutral-100 py-8 md:py-12">
      <div className="mx-auto w-full max-w-[560px] px-4">
        ...
        <button
          ...
          className="mb-4 flex items-center gap-1.5 text-sm text-foreground-alt hover:text-brand-navy transition-colors"
        >
