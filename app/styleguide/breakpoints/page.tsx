...
export default function BreakpointsPage() {
  return (
    <div>
      ...
      <div className="relative bg-neutral-50 border border-brand-border rounded-lg p-6 overflow-x-auto">
        {/* Scale bar */}
      ...
      {/* Usage note */}
      <div className="mt-8 p-4 bg-brand-orange/5 border border-brand-orange/20 rounded-lg">
