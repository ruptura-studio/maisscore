  ...
  return (
    <div>
      <div className="sg-prose">
        <h1 className="text-heading-2 font-dm font-normal text-brand-navy mb-2">Item</h1>
      ...
      <div className="sg-prose">
        <h2 className="text-heading-4 font-medium text-brand-navy mb-4 mt-10 pb-2 border-b border-brand-border">Lista de Benefícios</h2>
        <p className="text-para-sm text-neutral-400 mb-4">Items estáticos com ícone leading.</p>
      </div>
...
/>`} />
      ...
      <div className="sg-prose">
        <h2 className="text-heading-4 font-medium text-brand-navy mb-4 mt-10 pb-2 border-b border-brand-border">Items Interativos</h2>
        <p className="text-para-sm text-neutral-400 mb-4">Com <code className="font-mono bg-neutral-50 px-1 rounded">interactive</code> habilitado — hover com destaque.</p>
      </div>
      <div className="preview-full border border-brand-border rounded-lg p-4 flex flex-col bg-neutral-50 mb-4">
        <div className="bg-white rounded-lg border border-brand-border divide-y divide-brand-border">
