  ...
  return (
    <div>
      ...
      <div className="sg-prose">
        ...
        <p className="text-sm text-neutral-400 mb-4">Items estáticos com ícone leading.</p>
      </div>
...
/>`} />
      ...
      <div className="sg-prose">
        ...
        <p className="text-sm text-neutral-400 mb-4">Com <code className="font-mono bg-neutral-50 px-1 rounded">interactive</code> habilitado — hover com destaque.</p>
      </div>
      <div className="preview-full border border-brand-border rounded-lg p-4 flex flex-col bg-neutral-50 mb-4">
        <div className="bg-white rounded-lg border border-brand-border divide-y divide-brand-border">
