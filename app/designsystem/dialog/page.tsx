...
export default function DialogPage() {
  return (
    <div>
      <div className="sg-prose">
        <h1 className="text-heading-2 font-dm font-normal text-brand-navy mb-2">Dialog</h1>
      ...
      <div className="sg-prose">
        <h2 className="text-heading-4 font-medium text-brand-navy mb-4 mt-10 pb-2 border-b border-brand-border">Dialog Simples</h2>
        <p className="text-para-sm text-neutral-400 mb-4">Modal de confirmação com título, descrição e ações.</p>
      </div>
  ...
  <DialogContent>
    ...
    <DialogFooter>
      ...
      <div className="sg-prose">
        <h2 className="text-heading-4 font-medium text-brand-navy mb-4 mt-10 pb-2 border-b border-brand-border">Dialog com Formulário</h2>
        <p className="text-para-sm text-neutral-400 mb-4">Modal contendo campos de formulário.</p>
      </div>
      <div className="preview-full border border-brand-border rounded-lg p-8 flex items-center justify-center bg-neutral-50 mb-4">
        <Dialog>
          <DialogTrigger asChild>
