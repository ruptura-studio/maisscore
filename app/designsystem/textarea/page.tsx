  ...
  return (
    <div>
      <div className="sg-prose">
        <h1 className="text-heading-2 font-dm font-normal text-brand-navy mb-2">Textarea</h1>
      ...
      <div className="sg-prose">
        ...
        <p className="text-para-sm text-neutral-400 mb-4">Textarea com label e placeholder.</p>
      </div>
