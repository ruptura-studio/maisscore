  ...
  return (
    <div>
      <div className="sg-prose">
        <h1 className="text-heading-2 font-dm font-normal text-brand-navy mb-2">Checkbox</h1>
      ...
      <div className="sg-prose">
        <h2 className="text-heading-4 font-medium text-brand-navy mb-4 mt-10 pb-2 border-b border-brand-border">Padrão</h2>
        <p className="text-para-sm text-neutral-400 mb-4">Checkbox simples com label associado.</p>
      </div>
