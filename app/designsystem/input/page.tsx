  ...
  return (
    <div>
      <div className="sg-prose">
        <h1 className="text-heading-2 font-dm font-normal text-brand-navy mb-2">Input</h1>
      ...
      <div className="sg-prose">
        <h2 className="text-heading-4 font-medium text-brand-navy mb-4 mt-10 pb-2 border-b border-brand-border">Tipos</h2>
        <p className="text-para-sm text-neutral-400 mb-4">Variações por tipo de dado.</p>
      </div>
...
<Input type="tel" placeholder="(11) 99999-9999" />`} />
      ...
      <div className="sg-prose">
        <h2 className="text-heading-4 font-medium text-brand-navy mb-4 mt-10 pb-2 border-b border-brand-border">Estados</h2>
        <p className="text-para-sm text-neutral-400 mb-4">Disabled e com erro.</p>
      </div>
      <div className="preview-full border border-brand-border rounded-lg p-8 flex flex-col gap-4 bg-neutral-50 mb-4">
        <div className="grid gap-2 w-full max-w-sm">
