...
export function BeneficiosBar() {
  return (
    <section className="w-full bg-white border-t border-brand-navy/10">
      <div className="container-ms flex flex-col gap-8 py-10 sm:py-16 lg:flex-row lg:items-center lg:justify-between lg:gap-10 lg:py-0 lg:min-h-[305px]">

        {/* Heading com destaque laranja */}
        <p className="font-dm text-h2 text-brand-navy lg:flex-[0.42]">
          Seu nome limpo{' '}
